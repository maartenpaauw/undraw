<svg xmlns="http://www.w3.org/2000/svg" width="735.742" height="727.778" viewBox="0 0 735.742 727.778">
  <g id="Group_5" data-name="Group 5" transform="translate(-176.339 -93)">
    ...
    <g id="Group_1" data-name="Group 1" transform="translate(-1032.086 409.798)">
      ...
      <path id="Path_22" data-name="Path 22" d="M213.405,256.39l-11.334-8.422-7.477,11.392-33.663,19.8,19.8,51.484.99,50.495s-36.633,37.623-14.851,42.574,99.009,15.841,102.969,6.931-4.95-100.989-4.95-100.989l2.97-78.217-29.7-10.739Z" transform="translate(1301.146 -309)" fill="{{ $color }}"/>
      ...
      <path id="Path_28" data-name="Path 28" d="M285.1,255.678l7.921-.99s15.841,1.98,13.861,32.673-2.97,32.673-2.97,32.673-20.792-18.812-35.643-9.9Z" transform="translate(1275.99 -312.249)" fill="{{ $color }}"/>
      <path id="Path_29" data-name="Path 29" d="M161.741,290.8h-3.96a36.678,36.678,0,0,0-7.921,22.772,109.588,109.588,0,0,1-3.465,26.237l31.188-5.445Z" transform="translate(1304.296 -320.635)" fill="{{ $color }}"/>
    </g>
    <g id="Group_2" data-name="Group 2" transform="translate(-274 1272)">
      ...
      <path id="Path_67" data-name="Path 67" d="M16.955,0A16.955,16.955,0,1,1,0,16.955,16.955,16.955,0,0,1,16.955,0Z" transform="translate(911.857 -1033.48)" fill="{{ $color }}"/>
    ...
    <g id="Group_3" data-name="Group 3" transform="translate(-274 1353)">
      ...
      <circle id="Ellipse_10" data-name="Ellipse 10" cx="16.955" cy="16.955" r="16.955" transform="translate(911.857 -1033.48)" fill="{{ $color }}"/>
    ...
    <g id="Group_4" data-name="Group 4" transform="translate(-274 1434)">
      ...
      <circle id="Ellipse_10-2" data-name="Ellipse 10" cx="16.955" cy="16.955" r="16.955" transform="translate(911.857 -1033.48)" fill="{{ $color }}"/>
