<svg xmlns="http://www.w3.org/2000/svg" width="908.062" height="699.657" viewBox="0 0 908.062 699.657">
  <g id="Group_19" data-name="Group 19" transform="translate(-169.938 -93)">
    ...
    <g id="Group_18" data-name="Group 18" transform="translate(94.149 -64.901)">
      ...
      <rect id="Rectangle_56" data-name="Rectangle 56" width="67.917" height="67.917" rx="10.5" transform="translate(386.852 373.708)" fill="{{ $color }}"/>
      ...
      <g id="Group_15" data-name="Group 15" transform="translate(381.787 746.106)">
        <rect id="Rectangle_72" data-name="Rectangle 72" width="70.564" height="70.564" rx="10.5" transform="translate(0 0)" fill="{{ $color }}"/>
        <rect id="Rectangle_73" data-name="Rectangle 73" width="70.564" height="70.564" rx="10.5" transform="translate(87.102 0)" fill="{{ $color }}"/>
        <rect id="Rectangle_74" data-name="Rectangle 74" width="70.564" height="70.564" rx="10.5" transform="translate(174.205 0)" fill="{{ $color }}"/>
        <rect id="Rectangle_75" data-name="Rectangle 75" width="70.564" height="70.564" rx="10.5" transform="translate(261.307 0)" fill="{{ $color }}"/>
      </g>
    </g>
