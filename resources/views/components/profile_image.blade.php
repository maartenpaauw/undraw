<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 742.418 712.575">
  <g id="Group_29" data-name="Group 29" transform="translate(-245 -109)">
    ...
    <g id="Group_26" data-name="Group 26" transform="translate(402.822 206.2)">
      ...
      <g id="Group_27" data-name="Group 27" transform="translate(17.768 55.394)">
        ...
        <path id="Path_63" data-name="Path 63" d="M476.175,412.51h-104.6a2.141,2.141,0,0,1-.391-.031l49.472-85.686a3.463,3.463,0,0,1,6.029,0l33.2,57.5,1.59,2.751Z" transform="translate(-371.188 -325.034)" fill="{{ $color }}"/>
        <path id="Path_65" data-name="Path 65" d="M533.713,412.268H443.245l17.53-25.464,1.261-1.835,22.844-33.184a4.622,4.622,0,0,1,6.866-.41,4.131,4.131,0,0,1,.329.41Z" transform="translate(-370.49 -324.791)" fill="{{ $color }}"/>
      </g>
    </g>
    ...
    <circle id="Ellipse_5" data-name="Ellipse 5" cx="15.986" cy="15.986" r="15.986" transform="translate(410.001 464.033)" fill="{{ $color }}"/>
    ...
    <circle id="Ellipse_6" data-name="Ellipse 6" cx="15.986" cy="15.986" r="15.986" transform="translate(410.001 549.292)" fill="{{ $color }}"/>
    ...
    <circle id="Ellipse_5-2" data-name="Ellipse 5" cx="15.986" cy="15.986" r="15.986" transform="translate(410.001 634.552)" fill="{{ $color }}"/>
